...
import PricingFloorPlan from "./PricingFloorPlan";
...
function PropertyDetails({ propertyData }) {
  ...
  const [propertyTabs, setPropertyTabs] = useState(
    type === "Group Villa" || type === "Group Appartment"
      ? [
          { id: 0, name: "Gallery", icon: <BsImages /> },
          { id: 1, name: "Overview", icon: <AiOutlineInfoCircle /> },
          { id: 2, name: "About", icon: <BsPersonWorkspace /> },
          { id: 3, name: "Pricing & Floor Plan", icon: <GiMoneyStack /> },
        ...
        <Row className="property-details-content">
          ...
          {(type === "Group Villa" || type === "Group Appartment") && (
            <Col
              ...
              ref={refs[3]}
            >
              <PricingFloorPlan data={propertyData} />
            </Col>
          )}
          <Col
            span={24}
          ...
          <Col
            span={24}
            className="location tab-section"
            ref={
              type !== "Group Villa" && type !== "Group Appartment"
                ? refs[4]
                : refs[5]
