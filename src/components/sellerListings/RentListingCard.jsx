...
function RentListingCard({ item }) {
  ...
  const editHandler = () => {
    if (item?.rent_type === "Flat") {
      navigate(`/add-property/rent/flat/${item?.property_id}`);
    } else if (item?.rent_type === "Building") {
      navigate(`/add-property/rent/building/${item?.property_id}`);
    } else if (item?.rent_type === "Villa") {
      navigate(`/add-property/rent/villa/${item?.property_id}`);
    } else if (item?.rent_type === "Open Plot") {
      navigate(`/add-property/rent/plot/${item?.property_id}`);
    }
  };
